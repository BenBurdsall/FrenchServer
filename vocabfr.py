...
chores = [
    ...
    ["Ranger", "to tidy up"],
    ["Épousseter", "to dust"],
    ["Laver les fenêtres", "to wash the windows"],
    ["Tondre la pelouse", "to mow the lawn"],
    ["Arroser les plantes", "to water the plants"],
    ["Changer les draps", "to change the sheets"],
    ["Laver le sol", "to mop the floor"],
    ["Débarrasser la table", "to clear the table"],
    ["Faire la poussière", "to dust"]
]


totalFreToEng = freToEngNouns + harderFreToEng + freToEngVerbs + comparisons + connections + prep + prep2 + negs + questions + greeting + genGCSE  +weather + foundation + towns + higher + chores
